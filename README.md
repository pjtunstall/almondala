...
On my trusty 2013 MacBook Air, I compared 100 million calls, passing a random escape iteration value to the function that generates a colored pixel; likewise the function that generates a grayscale pixel. The `Vec<u8>` versions took 80 and 71 seconds respectively. The `[u8; 4]` versions took 60 and 52 seconds. With the current technique of lookup tables, this is further to 47 seconds.
