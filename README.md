...
On my trusty 2013 MacBook Air, I compared 100 million calls, passing a random escape iteration value to the function that generates a colored pixel; likewise the function that generates a grayscale pixel. The `Vec<u8>` versions took 80 and 71 seconds respectively. The `[u8; 4]` versions took 66 and 51 seconds. With the current technique of lookup tables, these values are reduced further to 56 and 47 seconds.
