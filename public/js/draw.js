...
export default class Renderer {
    ...
    draw(maxIterations, fullMaxIterations, rFactor, gFactor, bFactor, ctx, state) {
        ...
        const pixels = calculate_mandelbrot(width, height, maxIterations, fullMaxIterations, state.mid.x, state.mid.y, state.zoom, state.ratio, rFactor, gFactor, bFactor, 2);
