...
init().then(() => {
    ...
    onmessage = function (message) {
        ...
        const { requestId, tileWidth, tileHeight, canvasWidth, canvasHeight, maxIterations, fullMaxIterations, tileLeft, tileTop, mid, zoom, ratio, rFactor, gFactor, bFactor, power, grayscale, } = data;
